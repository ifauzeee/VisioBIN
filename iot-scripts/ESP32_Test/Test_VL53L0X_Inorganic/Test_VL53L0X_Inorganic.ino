/*
 * VisioBin - Test VL53L0X ToF Sensor (Kompartemen ANORGANIK)
 * ============================================================
 * Sketch khusus untuk menguji sensor jarak VL53L0X yang terhubung
 * ke Channel 1 pada multiplexer TCA9548A (kompartemen anorganik).
 *
 * Cara Pakai:
 * 1. Pastikan TCA9548A sudah terhubung (SDA=D21, SCL=D22)
 * 2. Pastikan VL53L0X Anorganik terhubung ke Channel 1 TCA9548A
 ...
 *   SDA : D21
 *   SCL : D22
 *   ToF Anorganik: TCA9548A Channel 1
 */
...
#define TOF_CHANNEL    1       // Channel 1 = Kompartemen Anorganik
...
void setup() {
  ...
  Serial.println("\n\n==========================================");
  Serial.println("   VisioBin - Test ToF VL53L0X ANORGANIK");
  Serial.println("   (TCA9548A Channel 1)");
  Serial.println("==========================================");
  ...
  if (!tof.begin()) {
    ...
    Serial.println("  2. Kabel dari TCA9548A Ch.1 ke VL53L0X");
