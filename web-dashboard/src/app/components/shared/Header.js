...
export default function Header({ setSidebarOpen }) {
  ...
  const viewMeta = {
    ...
    perangkat: { title: t('devices'), subtitle: "Status sensor dan kesehatan perangkat.", badge: "Aktif", color: "#06B6D4", icon: Cpu },
    ...
    team: { title: t('users'), subtitle: "Kelola akses pengguna dan peran dalam tim.", badge: "Manajemen Akses", color: "#8B5CF6", icon: Users },
    ...
    config: { title: t('settings'), subtitle: "Pengaturan threshold, polling, dan preferensi notifikasi.", badge: "Pengaturan", color: "#64748b", icon: Settings2 },
    profile: { title: t('profile'), subtitle: "Kelola informasi pribadi dan pengaturan keamanan akun.", badge: "Akun Terverifikasi", color: "var(--brand-organic)", icon: Users },
