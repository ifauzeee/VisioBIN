                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div className="progress-bar">
                    <motion.div 
                      ...
                      initial={{ width: 0 }}
                      animate={{ width: `${vO}%` }}
                      style={{ background: getBinLevelColor(vO) }} 
                    />
                  </div>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div className="progress-bar">
                    <motion.div 
                      ...
                      initial={{ width: 0 }}
                      animate={{ width: `${vI}%` }}
                      style={{ background: getBinLevelColor(vI) }} 
                    />
                  </div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                {isActive && (
                  <motion.div initial={{ x: -5, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
                    <ChevronRight size={14} color="var(--brand-organic)" />
                  </motion.div>
                )}
              </div>
            </motion.div>
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  style={{ padding: 16 }}
                >
                  <div className="card-title"><s.icon size={14} /> {s.label}</div>
                  <div style={{ fontSize: 28, fontWeight: 600, marginTop: 8, color: s.color }}>
                    {s.val}<span style={{ fontSize: 14, color: "var(--text-muted)" }}>{s.unit}</span>
                  </div>
                </motion.div>
              ))}
            </motion.div>
                    ...
                    <div style={{ padding: 16, background: "rgba(16,185,129,0.06)", borderRadius: 10, border: "1px solid rgba(16,185,129,0.15)" }}>
                      ...
                      <div className="progress-bar" style={{ marginTop: 8 }}>
                        <motion.div 
                          className="progress-fill" 
                          initial={{ width: 0 }}
                          animate={{ width: `${forecast.current_volume_organic_pct}%` }}
                          style={{ background: "var(--brand-organic)" }} 
                        />
                      </div>
                    </div>
                    ...
                    <div style={{ padding: 16, background: "rgba(59,130,246,0.06)", borderRadius: 10, border: "1px solid rgba(59,130,246,0.15)" }}>
                      ...
                      <div className="progress-bar" style={{ marginTop: 8 }}>
                        <motion.div 
                          className="progress-fill" 
                          initial={{ width: 0 }}
                          animate={{ width: `${forecast.current_volume_inorganic_pct}%` }}
                          style={{ background: "var(--brand-inorganic)" }} 
                        />
                      </div>
                    </div>
